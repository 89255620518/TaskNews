...
router.post("/paykeeper-webhook", async (req: Request, res: Response) => {
  try {
...
router.get("/:id/payment-status", authenticate, async (req: Request, res: Response) => {
  try {
...
router.get("/check-payments", authenticate, async (req: Request, res: Response) => {
  try {
